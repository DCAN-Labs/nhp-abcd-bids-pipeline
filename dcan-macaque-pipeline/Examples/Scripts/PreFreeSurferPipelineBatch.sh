...
main()
{
	...
	# convention, e.g.
	#
	# ${StudyFolder}/unprocessed/3T/T1w_MPR1_3T_T1w_MPR1.nii.gz
	# ${StudyFolder}/unprocessed/3T/T1w_MPR2_3T_T1w_MPR2.nii.gz
	#
	# ${StudyFolder}/unprocessed/3T/T2w_SPC1_3T_T2w_SPC1.nii.gz
	...
	for Subject in $Subjlist ; do
		...
		if ${ReverseEpi:-false}; then
			SpinEchoPhaseEncodePositive=${StudyFolder}/unprocessed/NIFTI/${Subject}_ReversePhaseEncodeEPI.nii.gz
			SpinEchoPhaseEncodeNegative=${StudyFolder}/unprocessed/NIFTI/${Subject}_rfMRI_REST1.nii.gz
		fi
		...
		#
		#   GEB0InputName="${StudyFolder}/unprocessed/3T/T1w_MPR1/${Subject}_3T_GradientEchoFieldMap.nii.gz"
		GEB0InputName="NONE"
