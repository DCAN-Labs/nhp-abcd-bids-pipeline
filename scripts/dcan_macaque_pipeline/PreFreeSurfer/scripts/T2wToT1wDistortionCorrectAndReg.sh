...
for TXw in $Modalities ; do
    ...
    # ADDED NEXT LINE FROM GLASSER'S SCRIPTS, NOT PRESENT IN FNL VERSION
    ${FSLDIR}/bin/invwarp --ref=${WD}/Magnitude --warp=${WD}/FieldMap_Warp${TXw}.nii.gz --out=${WD}/FieldMap_Warp${TXw}.nii.gz
