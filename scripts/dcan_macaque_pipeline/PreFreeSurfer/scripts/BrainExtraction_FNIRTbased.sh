...
### ERIC ADDED 1/26/2015: OBSOLETE NOW ###
### ${FSLDIR}/bin/fslmaths "$Input" -bin "$OutputBrainMask"
### cp "$Input".nii.gz "$OutputBrainExtractedImage".nii.gz
