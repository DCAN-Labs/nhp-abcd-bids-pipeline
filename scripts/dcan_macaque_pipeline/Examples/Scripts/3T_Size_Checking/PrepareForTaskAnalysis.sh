	...
	do
		...
		do
			...
			../generate_level1_fsf.sh \
				...
				--outdir=${StudyFolder}/MNINonLinear/Results/tfMRI_${task}_${direction}
		...
		mkdir -p ${StudyFolder}/MNINonLinear/Results/tfMRI_${task}
		cp -v ../../fsf_templates/tfMRI_${task}_hp200_s4_level2.fsf ${StudyFolder}/MNINonLinear/Results/tfMRI_${task}
